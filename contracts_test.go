...
func TestGenDeployContractTX(t *testing.T) {
	...
	input.Fee.Amount.SetString("21000000000000000000", 10) //10gwei*2100000
	input.Contract = []byte(contractABI)
	input.Args = append(input.Args, []byte(paramsJson)) //params
	input.Extra = Hex2Bytes(contractBin[2:])
	//
