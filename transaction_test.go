...
func TestGetTxBasicInfo(t *testing.T) {
	...
	input := &adaptor.GetTxBasicInfoInput{Hex2Bytes("7448307f010d968046bff8a03c6b493dd1b83c9ce6719eca94adb8f59f4a85ea")} //contract create
...
func TestGetContractInitialTx(t *testing.T) {
	input := &adaptor.GetContractInitialTxInput{Hex2Bytes("7448307f010d968046bff8a03c6b493dd1b83c9ce6719eca94adb8f59f4a85ea")} //contract create
